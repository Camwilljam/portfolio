...
$query = "SELECT* FROM articles WHERE logID = '$order'";
...
<html>
	...
	<form class = "deleteform" name="delete" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>"> <!-- this is the form to log in-->
	...
	<div class="row">
		...
		<h2>Your <span class="blue">Articles</span></h2>
